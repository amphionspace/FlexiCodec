...
from flexicodec.ar_tts.utils.class_utils import (
    COSYVOICE_EMB_CLASSES,
    COSYVOICE_ATTENTION_CLASSES,
    COSYVOICE_ACTIVATION_CLASSES,
)
from flexicodec.ar_tts.utils.mask import subsequent_mask, make_pad_mask
...
class TransformerDecoder(torch.nn.Module):
    ...
    def __init__(
        ...
        :param num_blocks:
        :param dropout_rate:
        :param positional_dropout_rate:
        :param self_attention_dropout_rate:
